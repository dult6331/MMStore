 ...
 */
@WebFilter(filterName = "CreateFilter", urlPatterns = {"/SignUp"})
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (user != null && pass != null && repass != null) {
                ...
                if (!va.checkName(user)) {
                    request.setAttribute("euser", "Invalid");
                    check = false;
                }
                if (!va.checkPass(pass)) {
                    request.setAttribute("epass", "Invalid");
                    check = false;
                }
                if (!pass.equals(repass)) {
                    request.setAttribute("erepass", "Not Match");
                    check = false;
                }
                if (check) {
                    ...
                    request.setAttribute("srepass", repass);
