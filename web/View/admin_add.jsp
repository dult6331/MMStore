            ...
            <table >
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" id="UnitslnStock" name="UnitslnStock" value="${product.getUnitsInStock()}" ></td>
                    </tr>
                    <tr>
                        <td>Description :</td>
                        <td><textarea  name="Description" rows="3"   >${product.getDescription()}</textarea></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>Is Continue :</td>
                        <td>
                            <input type="radio" id="is_continue" name="IsContinue" value="Yes" checked>Yes
                            <input type="radio" id="is_continue" name="IsContinue" value="No">No
                        </td>
                        <td>
                        </td>
                    </tr>
